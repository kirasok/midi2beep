...
if __name__ == "__main__":
    ...
    parser.add_argument("-reverse", action="store_true", help="Reverse channel priority (Use with merge). Usually gives better results if enabled")
    ...
    print("Beep command has been copied to clipboard")
